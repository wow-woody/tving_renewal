...
const MovieSwiper = ({ config }: Props) => {
    ...
    useEffect(() => {
        ...
        const fetchDetail = async () => {
            ...
            const krInfo = detail.release_dates?.results.find(
                ...
                <div className="featured-fixed">
                    <div className="featured-media">
                        {!activeItem ? (
                            ...
                            <iframe
                                key={currentVideoKey}
                                src={getAutoplaySrc(
                                    `https://www.youtube.com/embed/${currentVideoKey}`
                                )}
                    ...
                    {movieDetail && (
                        <Link to={`/movie/detail/${movieDetail.id}`} className="featured-info">
                            ...
                            <span className="desc movie-overview-3lines">
