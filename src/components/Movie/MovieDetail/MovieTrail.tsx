...
import './scss/MovieTrail.scss';
import MovieVPopup from './MovieVPopup';

const MovieTrail = () => {
  const { id } = useParams<{ id: string }>();
  const { videos, onFetchVideo } = useMovieStore();
  ...
  return (
    <section className="movieTrail-wrap">
      <div
      ...
      {showPopup && (
        <MovieVPopup youtubeKey={selectedVideoKey} onClose={() => setShowPopup(false)} />
      )}
    </section>
  );
};

export default MovieTrail;
