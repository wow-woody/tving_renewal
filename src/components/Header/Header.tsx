...
import ProfileSelect from '../User/Profile/ProfileSelect';
                ...
                <h1 className="logo">
                    <div className="logo-wrap">
                        <Link to="/" className={isOpen ? 'open' : ''}>
                            <img
                                className="logo-main"
                                src="/images/tving-logo-s.svg"
                                alt="mainLogo"
                            />
                            <img
                                className="logo-small"
                                src="/images/tving-logo-main.svg"
                                alt="smallLogo"
                            />
                        </Link>
                    </div>
                ...
                <ul className="side-menu">
                    ...
                    {!loading && user && (
                        <li className="setting-icon">
                            <Link
                                to={logoutMenu.path}
                                onClick={(e) => handleMenuClick(logoutMenu, e)}
                            >
