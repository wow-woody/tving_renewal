                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ID, 요청일시, 법정대리인의 성인여부, 법정대리인의 인증일시
                                    </td>
                                    <td className="bold">회원탈퇴 후 5일까지</td>
                                </tr>
                                <tr>
                                    <td>상품 구매 환불</td>
                                    <td>
                                        이름, 휴대폰 번호, 계좌주명, 계좌번호, 요금청구 및 결제 기록
                                    </td>
                                    <td className="bold">상품 구매 및 환불 후 5년까지</td>
                                </tr>
                                <tr>
                                    <td>
                                        서비스 개선 및 안정화, 서비스 부정 이용 방지, 서비스 분석 및
                                        통계, 최적화/추천 컨텐츠 및 서비스 제공
                                    </td>
                                    <td>
                                        이름, ID, 이메일 주소, 서비스 이용기록, 생년월일, 기기정보
                                    </td>
                                    <td className="bold">회원탈퇴 후 5일까지</td>
                                </tr>
                                <tr>
