...
const AppleTvSection = () => {
    ...
    // Apple TV 랭크 데이터 필터링
    const appleContents: Content[] = ALL_CONTENTS.filter(
        (item) => item.rank?.[RankScope.APPLE_TV] != null
    )
        .sort(
            ...
            <div className="apple-tv">
                ...
                <div className="apple-tv-slider">
                    ...
                    <div className="apple-tv-nav">
                        ...
                        >
                            <img className='arrow-LW' src="/images/arrow-LW.svg" alt="" />
                        </button>
                        <button
                            type="button"
                        ...
                        >
                            <img className='arrow-RW' src="/images/arrow-RW.svg" alt="" />
                        </button>
                    </div>
                </div>
            </div>
