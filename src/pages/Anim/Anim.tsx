...
import AnimSwiper from '../../components/Animation/AnimSwiper';
import SnoopySection from '../../components/Animation/SnoopySection';
import ZootopiaSection from '../../components/Animation/ZootopiaSection';
...
const Anim = () => {
    ...
    const anim20 = anim
        ...
        .sort(
            (a, b) => (a.rank?.[RankScope.POP_ANIM] ?? 999) - (b.rank?.[RankScope.POP_ANIM] ?? 999)
        )
        .slice(0, 20);
